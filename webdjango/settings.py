...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=10),     # ⏳ You can increase this if needed
    'REFRESH_TOKEN_LIFETIME': timedelta(days=1),
    'ROTATE_REFRESH_TOKENS': False,                     # Optional: new refresh token each time
    'BLACKLIST_AFTER_ROTATION': False,                  # Optional: invalidate old ones after rotation
